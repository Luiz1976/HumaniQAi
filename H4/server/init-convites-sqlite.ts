...
// Garante a criação das tabelas de convites no SQLite de desenvolvimento
export async function ensureConvitesTables() {
  try {
    // convites_empresa
    sqlite.exec(`
    ...
    console.error('❌ [SQLite] Erro ao garantir tabelas de convites:', error);
    throw error;
  }
}